...
matplotlib.rcParams['font.sans-serif'] = ['Microsoft JhengHei']  # 或 'Arial Unicode MS', 'SimHei'
...
# 按鈕：取得 Gemini 建議與圖表
btn_gemini = ttk.Button(root, text="Gemini 理財建議", command=get_financial_advice)
